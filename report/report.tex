...
\begin{document}
    ...
    \todo{Building up on the previous experiment we introduce a fairer notion, where \suckers obtain a greenbeard gene which allows them to differentiate between their own kind and \cowards.}
